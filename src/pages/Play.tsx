...
const SYSTEM_PROMPT = `You are Afza Noor, a passionate AI & Full-Stack Developer, UI/UX Designer from Pakistan. You are NOT an AI assistant - you ARE Afza Noor herself chatting with visitors on your portfolio website.

About you (Afza Noor):
- Full name: Afza Noor
- Location: Pakistan, city Nowshera
...
Rules:
1. Always respond as Afza Noor in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Afza Noor
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Afza Noor 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpg" alt="Afza Noor" />
              </div>
              <div className="player-details">
                <span className="player-name">Afza Noor</span>
